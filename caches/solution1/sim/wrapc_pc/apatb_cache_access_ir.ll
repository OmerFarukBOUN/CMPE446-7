; ModuleID = '/home/omerfaruk/Projects/okul/caches/caches/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define i32 @apatb_cache_access_ir(%"struct.ap_uint<11>"* nocapture readonly %address, i32 %value, i1 zeroext %action, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="2048" %mymem, i32 %test_value) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 8192)
  %mymem_copy = bitcast i8* %malloccall to [2048 x i32]*
  %0 = bitcast i32* %mymem to [2048 x i32]*
  call fastcc void @copy_in([2048 x i32]* nonnull %0, [2048 x i32]* %mymem_copy)
  %1 = call i32 @apatb_cache_access_hw(%"struct.ap_uint<11>"* %address, i32 %value, i1 %action, [2048 x i32]* %mymem_copy, i32 %test_value)
  call void @copy_back([2048 x i32]* %0, [2048 x i32]* %mymem_copy)
...
define internal fastcc void @copy_in([2048 x i32]* noalias readonly, [2048 x i32]* noalias) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_out([2048 x i32]* noalias, [2048 x i32]* noalias readonly) unnamed_addr #4 {
entry:
...
declare i32 @apatb_cache_access_hw(%"struct.ap_uint<11>"*, i32, i1, [2048 x i32]*, i32)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @copy_back([2048 x i32]* noalias, [2048 x i32]* noalias readonly) unnamed_addr #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a2048i32([2048 x i32]* %0, [2048 x i32]* %1)
  ret void
}

define i32 @cache_access_hw_stub_wrapper(%"struct.ap_uint<11>"*, i32, i1, [2048 x i32]*, i32) #5 {
entry:
  call void @copy_out([2048 x i32]* null, [2048 x i32]* %3)
  %5 = bitcast [2048 x i32]* %3 to i32*
  %6 = call i32 @cache_access_hw_stub(%"struct.ap_uint<11>"* %0, i32 %1, i1 %2, i32* %5, i32 %4)
  call void @copy_in([2048 x i32]* null, [2048 x i32]* %3)
  ret i32 %6
}

declare i32 @cache_access_hw_stub(%"struct.ap_uint<11>"*, i32, i1, i32*, i32)
