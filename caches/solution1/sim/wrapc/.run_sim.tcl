...
# 
# ==============================================================
set ::env(LD_LIBRARY_PATH) /home/omerfaruk/tools/Xilinx/Vitis_HLS/2023.2/lnx64/tools/fpo_v7_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/omerfaruk/tools/Xilinx/Vitis_HLS/2023.2/lnx64/tools/fft_v9_1:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/omerfaruk/tools/Xilinx/Vitis_HLS/2023.2/lnx64/tools/fir_v7_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) /home/omerfaruk/tools/Xilinx/Vitis_HLS/2023.2/lnx64/tools/dds_v6_0:$::env(LD_LIBRARY_PATH)
set ::env(LD_LIBRARY_PATH) $::env(LD_LIBRARY_PATH):/usr/lib/x86_64-linux-gnu
set ::env(LD_LIBRARY_PATH) /home/omerfaruk/tools/Xilinx/Vitis_HLS/2023.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "cache_access.autotvin.dat"
	set constFileTvOut       "cache_access.autotvout.dat"
	set constFileHdlTvIn     "cache_access.autohdltvin.dat"
	set constFileHdlTvOut    "cache_access.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
