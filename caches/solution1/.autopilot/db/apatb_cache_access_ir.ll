...
define i32 @apatb_cache_access_ir(%"struct.ap_uint<11>"* nocapture readonly %address, i32 %value, i1 zeroext %action, i32* noalias nocapture nonnull "fpga.decayed.dim.hint"="2048" %mymem) local_unnamed_addr #0 {
entry:
  ...
  %1 = call i32 @apatb_cache_access_hw(%"struct.ap_uint<11>"* %address, i32 %value, i1 %action, [2048 x i32]* %mymem_copy)
...
declare i32 @apatb_cache_access_hw(%"struct.ap_uint<11>"*, i32, i1, [2048 x i32]*)
...
define i32 @cache_access_hw_stub_wrapper(%"struct.ap_uint<11>"*, i32, i1, [2048 x i32]*) #5 {
entry:
  call void @copy_out([2048 x i32]* null, [2048 x i32]* %3)
  %4 = bitcast [2048 x i32]* %3 to i32*
  %5 = call i32 @cache_access_hw_stub(%"struct.ap_uint<11>"* %0, i32 %1, i1 %2, i32* %4)
  call void @copy_in([2048 x i32]* null, [2048 x i32]* %3)
  ret i32 %5
}

declare i32 @cache_access_hw_stub(%"struct.ap_uint<11>"*, i32, i1, i32*)
